...
public class Prices {
	...
	public static void main(String[] args) {
		...
		System.out.println("Baking: " + Arrays.toString(prices2[0]));
		System.out.println("Beverage: " + Arrays.toString(prices2[1]));
		System.out.println("Cereals: " + Arrays.toString(prices2[2]));
